...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="a8ed8f48-c9f8-4a38-9eb1-7fb9ddbcb10c" name="Default" comment="" />
  ...
  <component name="FileEditorManager">
    <leaf>
      ...
      <file leaf-file-name="MainActivity.java" pinned="false" current-in-tab="true">
        <entry file="file://$PROJECT_DIR$/app/src/main/java/com/example/user/wifiscan/MainActivity.java">
  ...
  <component name="GradleLocalSettings">
    <option name="myGradleHomes">
      <map>
        <entry key="$PROJECT_DIR$" value="C:\Users\User\.gradle\wrapper\dists\gradle-4.6-all\bcst21l2brirad8k2ben1letg\gradle-4.6" />
      </map>
    </option>
